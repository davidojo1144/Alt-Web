          ...
          <div>
            ...
            <div className='lg:p-8 md:p-4 p-8'>
                <div className='flex gap-5 items-center'>
                    <img className='w-3 h-5 cursor-pointer' src={assets.arrowback} alt="" onClick={() => setTitle("")}/>
                    <h1 className='text-black text-2xl font-semibold'>Add Pickup Address</h1>
                </div>
                <p className='text-sm font-normal text-gray-500 ml-[8%] md:ml-[3%]'>Please enter the address your driver should pick this item</p>

                <div className='w-full md:w-[80%] lg:w-[60%] flex flex-col md:flex-row gap-5 mt-10'>
            ...
            <input className='w-full md:w-[90%] lg:w-[70%] mt-5 py-2 border border-gray-500 outline-none rounded p-2' type="text" placeholder='Address'/>
            <div className='w-full flex flex-col md:flex-row gap-5 mt-5'>
                ...
                <div className='w-full md:w-[90%] lg:w-[80%] flex flex-col md:flex-row gap-5 mt-5'>
                    <input className='w-full py-2 border border-gray-500 outline-none rounded p-2' type="tel" placeholder='Phone number'/>
                    <input className='w-full py-2 border border-gray-500 outline-none rounded p-2' type="text" placeholder='Item'/>
                </div>
               <div className='mt-5 flex flex-col md:flex-row gap-4 items-center'>
                    ...
                    <p className='text-gray-600 text-sm font-normal'>Save address to use on next delivery</p>
                </div>
                <button className='bg-red-500 hover:bg-red-600 text-white py-1 px-5 rounded ml-[35%] md:ml-[40%] mt-10 md:mt-5' onClick={() => setTitle("what are you shipping")}>Proceed</button>
            </div>
          </div>
          </>
        )
