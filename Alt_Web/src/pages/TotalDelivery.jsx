...
const TotalDelivery = () => {
  const {totalDelivery} = useContext(AltWebContext)
    ...
    return (
        ...
        <div>
          ...
          <div className='lg:p-8 md:p-4 p-8'>
            <div>
              <h1 className='text-2xl font-semibold'>Total Deliveries</h1>
              <p className='text-xs font-normal'>you have {totalDelivery} total deliveries</p>
            </div>
