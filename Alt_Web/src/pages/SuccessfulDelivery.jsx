...
const SuccessfulDelivery = () => {
 const {successfulDelivery} = useContext(AltWebContext)
   ...
   return (
       ...
       <div>
         ...
         <div className='lg:p-8 md:p-4 p-8'>
           <div>
             <h1 className='text-2xl font-semibold'>Successful Deliveries</h1>
             <p className='text-xs font-normal'>you have {successfulDelivery} successful deliveries</p>
           </div>
